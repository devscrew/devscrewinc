...
const Home = () => {
  ...
  return (
    <div className="container">
        ...
        <div className="grid" style={{gridTemplateColumns: '1fr 1fr', gap: '3rem', alignItems: 'center'}}>
          <div>
            ...
            <div className="cta-button">
              ...
              <Link to="/services" className="btn btn-secondary" style={{marginLeft:'1rem'}}>Our Services</Link>
            </div>
          </div>
          <div>
        ...
        <div className="grid" style={{gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '2rem'}}>
          {services.map((service, index) => (
            <div key={index} className="service-card" style={{padding:'2rem', borderRadius:'10px', backgroundColor:'white', boxShadow:'0 5px 15px rgba(0,0,0,0.05)', transition:'transform 0.3s ease'}}>
              <h3 style={{color:'#1a5fb4', marginBottom:'1rem'}}>{service.title}</h3>
      ...
      <section className="section">
        ...
        <div className="grid" style={{gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: '2rem'}}>
          <div className="feature-card" style={{textAlign:'center', padding:'2rem'}}>
            <div style={{fontSize:'3rem', color:'#1a5fb4', marginBottom:'1rem'}}>🏆</div>
      ...
      {/* Call to Action */}
      <section className="section" style={{backgroundColor:'#1a5fb4', color:'white', textAlign:'center', padding:'5rem 2rem'}}>
        <h2 className="section-title" style={{color:'white'}}>Ready to Transform Your Business?</h2>
        <p className="mb-4" style={{fontSize:'1.25rem', maxWidth:'700px', margin:'0 auto'}}>Let us help you maximize the value of your NetSuite and SuiteCommerce investments.</p>
        <div className="cta-button">
          <Link to="/contact" className="btn btn-primary" style={{backgroundColor:'#f59e0b', color:'#1f2937', fontWeight:'bold'}}>Schedule a Consultation</Link>
        </div>
      </section>
    </div>
  );
