    ...
    <div className="container">
      <section className="section" style={{paddingTop:'8rem'}}>
        <div className="text-center mb-8">
          ...
          <h1 className="section-title" style={{color:'#ac2a29'}}>NetSuite & SuiteCommerce Solutions</h1>
        ...
        <div className="grid" style={{gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '2rem', marginBottom:'4rem'}}>
          <div style={{padding:'2rem', borderRadius:'10px', backgroundColor:'#f8fafc', border:'1px solid #e5e7eb'}}>
            <h3 style={{color:'#ac2a29', marginBottom:'1rem'}}>NetSuite Implementation</h3>
          ...
          <div style={{padding:'2rem', borderRadius:'10px', backgroundColor:'#f8fafc', border:'1px solid #e5e7eb'}}>
            <h3 style={{color:'#ac2a29', marginBottom:'1rem'}}>SuiteCommerce Customization</h3>
          ...
          <div style={{padding:'2rem', borderRadius:'10px', backgroundColor:'#f8fafc', border:'1px solid #e5e7eb'}}>
            <h3 style={{color:'#ac2a29', marginBottom:'1rem'}}>Consultation & Strategy</h3>
          ...
          <div style={{padding:'2rem', borderRadius:'10px', backgroundColor:'#f8fafc', border:'1px solid #e5e7eb'}}>
            <h3 style={{color:'#ac2a29', marginBottom:'1rem'}}>Integration Services</h3>
          ...
          <div style={{padding:'2rem', borderRadius:'10px', backgroundColor:'#f8fafc', border:'1px solid #e5e7eb'}}>
            <h3 style={{color:'#ac2a29', marginBottom:'1rem'}}>Ongoing Support & Maintenance</h3>
          ...
          <div style={{padding:'2rem', borderRadius:'10px', backgroundColor:'#f8fafc', border:'1px solid #e5e7eb'}}>
            <h3 style={{color:'#ac2a29', marginBottom:'1rem'}}>Training & Knowledge Transfer</h3>
